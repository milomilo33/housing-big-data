# 3. Number of different types of crime within timeframe
...
OUTPUT_PATH = "/home/housing-big-data/transformation-zone/num-of-different-types"
...
spark = SparkSession \
    .builder \
    .appName("3. Number of different types of crime within timeframe") \
    .getOrCreate()
...
query = crimes \
    ...
    .groupBy(window("timestamp", "12 seconds", "4 seconds")) \
    .agg(approx_count_distinct("crime_type").alias("num_different_types")) \
    .orderBy(desc('window')) \
...
query.select('window.start', 'window.end', 'num_different_types') \
    .writeStream \
